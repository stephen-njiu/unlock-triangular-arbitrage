...
def step_1(coin_list, num_of_pairs=500):
    ...
    triangular_pairs = func_arbitrage.get_triangular_pairs_from_market(coin_list)
    print(len(triangular_pairs))
    # save to a json file
...
def step_2():
    ...
    for pair in structured_pairs:
        # print("Calculating Arbitrage for ...", pair['a_base'], pair['b_base'], pair['c_base'])
        time.sleep(0.3)
