...
// READ FILE //////////////////////////////
const url = 'https://mainnet.infura.io/v3/9833ceb4e7c54187bbf769eae0ed1533'
...
async function getPrice(factory, amtIn, tradeDirection) {
  ...
  // Get Provider
  const provider = new ethers.providers.JsonRpcProvider("https://mainnet.infura.io/v3/9833ceb4e7c54187bbf769eae0ed1533");
  const ABI = [
